            ...
            <ul className="mt-6 space-y-6">
              <li className="flex items-start gap-4">
                ...
                <div className="min-w-0">
                  ...
                  <a href={practice.contact.phoneHref} className="text-lg font-semibold text-primary-800 hover:underline sm:text-xl">
              ...
              <li className="flex items-start gap-4">
                ...
                <div className="min-w-0">
                  ...
                  <a href={`mailto:${practice.contact.email}`} className="block break-all text-base font-semibold text-primary-800 hover:underline sm:text-lg">
